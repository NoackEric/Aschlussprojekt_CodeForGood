    ...
    return (
        <article className='Sonstiges'>
            <section className='SonstigesSection'>
                ...
                <p>Auch wir können diese Frage nicht verhindern, welches Budget hast du?</p>
                <form action="">
                    ...
                    <br />
                    <Link to="/thanks" className='formular-btn' onClick={props.auftragHandler}>Briefing absenden</Link>
                </form>
            </section>
        </article>
    );
